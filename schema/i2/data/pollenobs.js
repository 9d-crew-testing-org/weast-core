...
async function getData(initType, location) {
    ...
    const data = await handleDataReq(`https://api.weather.com/v1/geocode/${i2LFR.lat}/${i2LFR.long}/observations/pollen.xml?apiKey=e1f10a1e78da46f5b10a1e78da96f525`, false)
    const i2OBJ = require("../objects/pollenfcst")({ data: data.split("<response>")[1].split("</response>")[0], plln: i2LFR.pllnId })
    return i2OBJ
}
