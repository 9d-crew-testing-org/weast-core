...
async function getData(initType, location) {
    ...
    const data = await handleDataReq(`https://api.weather.com/v2/indices/drySkin/daypart/3day?geocode=${i2LFR.lat},${i2LFR.long}&format=xml&language=en-US&apiKey=e1f10a1e78da46f5b10a1e78da96f525`, false)
    const i2OBJ = require("../objects/dryskin")({ data: data.split("<daypartForecastResponse>")[1].split("</daypartForecastResponse>")[0], coopId: i2LFR.coopId })
    return i2OBJ
}
